      ...
      <section className="relative min-h-[70vh] flex items-center">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a href="tel:+18641234567" className="inline-flex items-center justify-center gap-2 border-2 border-gold text-gold font-sans font-semibold px-8 py-4 rounded hover:bg-gold/10 hover:scale-105 hover:shadow-lg transition-all duration-200 uppercase text-sm tracking-wider text-center">
      ...
      <section id="contact" className="bg-navy py-20 md:py-28">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="tel:+18641234567" className="inline-flex items-center justify-center gap-2 border-2 border-gold text-gold font-sans font-semibold px-10 py-4 rounded hover:bg-gold/10 hover:scale-105 hover:shadow-lg transition-all duration-200 uppercase text-sm tracking-wider text-center">
              <Phone className="h-4 w-4" />
              Call Now
            </a>
          </div>
